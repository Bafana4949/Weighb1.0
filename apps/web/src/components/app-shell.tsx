...
const nav = {
  ...
  ADMIN: [
    ...
    { group: "Hardware & Installation", superAdminOnly: true },
    { href: "/admin/hardware/installations", label: "Installations", icon: Server, superAdminOnly: true },
    { href: "/admin/hardware/devices", label: "Devices", icon: Cpu, superAdminOnly: true },
    { href: "/admin/hardware/rfid", label: "RFID Management", icon: Radio, superAdminOnly: true },
