...
export const companyUpdateSchema = transporterUpdateSchema;
...
export const orderSchema = orderBaseSchema
  ...
  .refine((value) => value.originSiteId !== value.destinationSiteId, { message: "Origin and destination must be different places", path: ["destinationSiteId"] });
